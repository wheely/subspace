...
func init() {
	...
	cli.StringVar(&networkIPv4, "network-ipv4", "10.99.80.0/20", "IPV4 network address to create. First one is reserved by server.")
	cli.StringVar(&networkIPv6, "network-ipv6", "fd00::10:99:0/64", "IPV6 network address to create. First one is reserved by server.")
